...
contains
   ...
   subroutine stage_kernel_1(dx1_0, dy1_0, dzn_0, dzs_0, u_0, v_0, w_0, f_1, g_1, h_1)
      ...
      integer, dimension(1:2), parameter :: s15=(/ 198 , 199 /)
      integer, dimension(1:5), parameter :: s1=(/ 13, 145, 156, 157, 168 /)
      real, dimension(1:2, 1:5) :: svec_f_1_g_1_h_1_17
      integer :: s_idx_1
      integer :: s_idx_2
      integer, dimension(1:5), parameter :: s3=(/ 13, 145, 146, 156, 157 /)
      ...
      integer, dimension(1:2), parameter :: s12=(/ 183 , 196 /)
      integer, dimension(1:2), parameter :: s7=(/ 183 , 352 /)
      integer, dimension(1:2), parameter :: s9=(/ 183 , 184 /)
      integer, dimension(1:2), parameter :: s11=(/ 198 , 212 /)
      integer, dimension(1:2), parameter :: s5=(/ 156 , 300 /)
      ...
      integer, dimension(1:2), parameter :: s6=(/ 145 , 289 /)
...
! RF4A Begin Inline
      do s_idx_1 = 1, 2
      do s_idx_2 = 1, 5
      if (idx + s15(s_idx_1) + s1(s_idx_2) >= 1 .and. idx + s15(s_idx_1) + s1(s_idx_2) <= 13248) then
         svec_f_1_g_1_h_1_17(s_idx_1, s_idx_2) = u_0(idx + s15(s_idx_1) + s1(s_idx_2))
      else
      ...
      do s_idx_1 = 1, 2
      do s_idx_2 = 1, 5
      if (idx + s15(s_idx_1) + s3(s_idx_2) >= 1 .and. idx + s15(s_idx_1) + s3(s_idx_2) <= 13248) then
         svec_f_1_g_1_h_1_18(s_idx_1, s_idx_2) = v_0(idx + s15(s_idx_1) + s3(s_idx_2))
      else
      ...
      do s_idx_1 = 1, 2
      do s_idx_2 = 1, 4
      if (idx + s15(s_idx_1) + s2(s_idx_2) >= 1 .and. idx + s15(s_idx_1) + s2(s_idx_2) <= 13248) then
         svec_f_1_g_1_h_1_19(s_idx_1, s_idx_2) = w_0(idx + s15(s_idx_1) + s2(s_idx_2))
      else
      ...
      do s_idx_1 = 1, 2
      do s_idx_2 = 1, 2
       if (idx + s9(s_idx_1) + s5(s_idx_2) >= 1 .and. idx + s9(s_idx_1) + s5(s_idx_2) <= 13248) then
         svec_f_1_g_1_h_1_32(s_idx_1, s_idx_2) = u_0(idx + s9(s_idx_1) + s5(s_idx_2))
       else
      ...
      do s_idx_1 = 1, 2
      do s_idx_2 = 1, 3
       if (idx + s9(s_idx_1) + s4(s_idx_2) >= 1 .and. idx + s9(s_idx_1) + s4(s_idx_2) <= 13248) then
         svec_f_1_g_1_h_1_33(s_idx_1, s_idx_2) = w_0(idx + s9(s_idx_1) + s4(s_idx_2))
       else
      ...
      do s_idx_1 = 1, 2
      do s_idx_2 = 1, 2
       if (idx + s9(s_idx_1) + s6(s_idx_2) >= 1 .and. idx + s9(s_idx_1) + s6(s_idx_2) <= 13248) then
         svec_f_1_g_1_h_1_34(s_idx_1, s_idx_2) = v_0(idx + s9(s_idx_1) + s6(s_idx_2))
       else
      ...
      do i___f_maps_f_1_g_1_h_1_1 = 1, 2
         ...
         k_vel2_rel___velfg_map_76_scal = (global_id/                                            (j_vel2_range___velfg_m___4b6e60e4*i_vel2_range___velfg_m___ea66ec4a))
         k_vel2___velfg_map_76_scal = (k_vel2_rel___velfg_map_76_scal + 1)
         j_vel2_rel___velfg_map_76_scal = ((global_id - (k_vel2_rel___velfg_map_76_scal                                                          *(j_vel2_range___velfg_m___4b6e60e4*i_vel2_range___velfg_m___ea66ec4a)))/                                            i_vel2_range___velfg_m___ea66ec4a)
         i_vel2_rel___velfg_map_76_scal = ((global_id - (k_vel2_rel___velfg_map_76_scal                                                         *(j_vel2_range___velfg_m___4b6e60e4*i_vel2_range___velfg_m___ea66ec4a))) -                                            (j_vel2_rel___velfg_map_76_scal*i_vel2_range___velfg_m___ea66ec4a))
      ...
      k_rel___velfg_map_218_scal = (global_id/(j_range___velfg_map_218_scal*                                                i_range___velfg_map_218_scal))
      k___velfg_map_218_scal = (k_rel___velfg_map_218_scal + 1)
      j_rel___velfg_map_218_scal = ((global_id - (k_rel___velfg_map_218_scal*                                                   (j_range___velfg_map_218_scal*i_range___velfg_map_218_scal)))/                                     i_range___velfg_map_218_scal)
      j___velfg_map_218_scal = (j_rel___velfg_map_218_scal + 1)
      i_rel___velfg_map_218_scal = ((global_id - (k_rel___velfg_map_218_scal*                                                   (j_range___velfg_map_218_scal*i_range___velfg_map_218_scal))) -                                     (j_rel___velfg_map_218_scal*i_range___velfg_map_218_scal))
