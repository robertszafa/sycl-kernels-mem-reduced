...
contains
   ...
   ! RF4A Begin Inline
         do s_idx_1 = 1, 2
         do s_idx_2 = 1, 5
            svec_f_1_g_1_h_1_17(s_idx_1, s_idx_2) = u_0( global_id + s15(s_idx_1) + s1(s_idx_2))
         end do
         end do
         do s_idx_1 = 1, 2
         do s_idx_2 = 1, 5
            svec_f_1_g_1_h_1_18(s_idx_1, s_idx_2) = v_0( global_id + s15(s_idx_1) + s3(s_idx_2))
         end do
         end do
         do s_idx_1 = 1, 2
         do s_idx_2 = 1, 4
            svec_f_1_g_1_h_1_19(s_idx_1, s_idx_2) = w_0( global_id + s15(s_idx_1) + s2(s_idx_2))
         end do
         end do
         do s_idx_1 = 1, 2
         do s_idx_2 = 1, 2
            svec_f_1_g_1_h_1_32(s_idx_1, s_idx_2) = u_0( global_id + s9(s_idx_1) + s5(s_idx_2))
         end do
         end do
         do s_idx_1 = 1, 2
         do s_idx_2 = 1, 3
            svec_f_1_g_1_h_1_33(s_idx_1, s_idx_2) = w_0( global_id + s9(s_idx_1) + s4(s_idx_2))
         end do
         end do
         do s_idx_1 = 1, 2
         do s_idx_2 = 1, 2
            svec_f_1_g_1_h_1_34(s_idx_1, s_idx_2) = v_0( global_id + s9(s_idx_1) + s6(s_idx_2))
         end do
         end do
   ...
   cov7_s_0___f_comp_f_1____f85a90f2(i___f_maps_f_1_g_1_h_1_11) = (nou7___velfg_map_133 - u0___velfg_map_133_scal)*diu7___velfg_map_133
         ...
         f_1( global_id) = (-covc___velfg_map_218_scal + df___velfg_map_218_scal)
         ...
         g_1( global_id) = (-covc___velfg_map_218_scal + df___velfg_map_218_scal)
         if ((k___velfg_map_218_scal < (kp___velfg_map_218_scal - 1))) then
            ...
            h_1( global_id) = (-covc___velfg_map_218_scal + df___velfg_map_218_scal)
         end if
      end do
