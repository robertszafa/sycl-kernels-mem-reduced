...
!RF4A Begin Inline
 ...
 do s_idx_1 = 1,2
 do s_idx_2 = 1,5
 if (idx+s9(s_idx_1)+s1(s_idx_2)>=1 .and. idx+s9(s_idx_1)+s1(s_idx_2)<=13248) then
 ...
 do s_idx_1 = 1,2
 do s_idx_2 = 1,5
 if (idx+s9(s_idx_1)+s3(s_idx_2)>=1 .and. idx+s9(s_idx_1)+s3(s_idx_2)<=13248) then
 ...
 do s_idx_1 = 1,2
 do s_idx_2 = 1,4
 if (idx+s9(s_idx_1)+s2(s_idx_2)>=1 .and. idx+s9(s_idx_1)+s2(s_idx_2)<=13248) then
 ...
 do s_idx_1 = 1,2
 do s_idx_2 = 1,2
 if (idx+s12(s_idx_1)+s5(s_idx_2)>=1 .and. idx+s12(s_idx_1)+s5(s_idx_2)<=13248) then
 svec_f_1_g_1_h_1_35(s_idx_1, s_idx_2) = u_0(idx+s12(s_idx_1)+s5(s_idx_2))
 else
 ...
 do s_idx_1 = 1,2
 do s_idx_2 = 1,3
 if (idx+s12(s_idx_1)+s4(s_idx_2)>=1 .and. idx+s12(s_idx_1)+s4(s_idx_2)<=13248) then
 svec_f_1_g_1_h_1_36(s_idx_1, s_idx_2) = w_0(idx+s12(s_idx_1)+s4(s_idx_2))
 else
 ...
 do s_idx_1 = 1,2
 do s_idx_2 = 1,2
 if (idx+s12(s_idx_1)+s6(s_idx_2)>=1 .and. idx+s12(s_idx_1)+s6(s_idx_2)<=13248) then
 svec_f_1_g_1_h_1_37(s_idx_1, s_idx_2) = v_0(idx+s12(s_idx_1)+s6(s_idx_2))
 else
 ...
 k_vel2_rel___velfg_map_133_scal = (global_id___velfg_map_133_scal /  &
 ...
 j_vel2_rel___velfg_map_133_scal = ((global_id___velfg_map_133_scal -  &
 ...
 i_vel2_rel___velfg_map_133_scal = ((global_id___velfg_map_133_scal -  &
      (k_vel2_rel___velfg_map_133_scal * (j_vel2_range___velfg_m___9675913f *  &
