...
void velfg_ndrange(queue &q, const std::vector<float> &u,
  ...
  buffer<float> cov1_buf(uvw_range), cov2_buf(uvw_range), cov3_buf(uvw_range),
      cov4_buf(uvw_range), cov5_buf(uvw_range), cov6_buf(uvw_range), cov7_buf(uvw_range), 
      cov8_buf(uvw_range), cov9_buf(uvw_range);
  ...
  q.submit([&](handler &hnd) {
    ...
    hnd.parallel_for(DOMAIN_SIZE, [=](id<1> item_id) {
      ...
      k_vel2 = k_vel2_rel + 1;
      j_vel2_rel = ((global_id - (k_vel2_rel * (j_vel2_range * i_vel2_range))) /
                    i_vel2_range);
      j_vel2 = j_vel2_rel + 1;
      ...
      if ((k_vel2 < KP)) {
        nou1[F3D2C((((IP + 2) - (-1)) + 1), (((JP + 2) - 0) + 1), (-1), 0, 0,
                   i_vel2, j_vel2, k_vel2)] =
            (u[F3D2C((((IP + 1) - 0) + 1), (((JP + 1) - 0) + 1), 0, 0, 0,
        ...
        diu1[F3D2C((((IP + 2) - (-1)) + 1), (((JP + 2) - 0) + 1), (-1), 0, 0,
            ...
            (-u[F3D2C((((IP + 1) - 0) + 1), (((JP + 1) - 0) + 1), 0, 0, 0,
             ...
             u[F3D2C((((IP + 1) - 0) + 1), (((JP + 1) - 0) + 1), 0, 0, 0,
                     i_vel2, j_vel2, k_vel2)]) /
            dx1[F1D2C((-1), i_vel2)];
        nou5[F3D2C((((IP + 2) - (-1)) + 1), (((JP + 2) - 0) + 1), (-1), 0, 0,
                   i_vel2, j_vel2, k_vel2)] =
            (v[F3D2C((((IP + 1) - 0) + 1), (((JP + 1) - 0) + 1), 0, 0, 0,
                     i_vel2, j_vel2 - 1, k_vel2)] +
             v[F3D2C((((IP + 1) - 0) + 1), (((JP + 1) - 0) + 1), 0, 0, 0,
                     i_vel2, j_vel2, k_vel2)]) /
            2.;
        diu5[F3D2C((((IP + 2) - (-1)) + 1), (((JP + 2) - 0) + 1), (-1), 0, 0,
            ...
            (-v[F3D2C((((IP + 1) - 0) + 1), (((JP + 1) - 0) + 1), 0, 0, 0,
             ...
             v[F3D2C((((IP + 1) - 0) + 1), (((JP + 1) - 0) + 1), 0, 0, 0,
                     i_vel2, j_vel2, k_vel2)]) /
            dy1[F1D2C(0, j_vel2)];
        nou9[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0, i_vel2,
                   j_vel2, k_vel2)] =
            (w[F3D2C((((IP + 1) - 0) + 1), (((JP + 1) - 0) + 1), 0, 0, 0,
                     i_vel2, j_vel2, k_vel2 - 1)] +
             w[F3D2C((((IP + 1) - 0) + 1), (((JP + 1) - 0) + 1), 0, 0, 0,
                     i_vel2, j_vel2, k_vel2)]) /
            2.;
        diu9[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0, i_vel2,
                   j_vel2, k_vel2)] =
            (-w[F3D2C((((IP + 1) - 0) + 1), (((JP + 1) - 0) + 1), 0, 0, 0,
                      i_vel2, j_vel2, k_vel2 - 1)] +
             w[F3D2C((((IP + 1) - 0) + 1), (((JP + 1) - 0) + 1), 0, 0, 0,
                     i_vel2, j_vel2, k_vel2)]) /
            dzn[F1D2C((-1), k_vel2)];
        cov1[F3D2C((((IP + 2) - (-1)) + 1), (((JP + 2) - 0) + 1), (-1), 0, 0,
                   i_vel2, j_vel2, k_vel2)] =
            nou1[F3D2C((((IP + 2) - (-1)) + 1), (((JP + 2) - 0) + 1), (-1), 0,
                       0, i_vel2, j_vel2, k_vel2)] *
            diu1[F3D2C((((IP + 2) - (-1)) + 1), (((JP + 2) - 0) + 1), (-1), 0,
                       0, i_vel2, j_vel2, k_vel2)];
        cov5[F3D2C((((IP + 2) - (-1)) + 1), (((JP + 2) - 0) + 1), (-1), 0, 0,
                   i_vel2, j_vel2, k_vel2)] =
            nou5[F3D2C((((IP + 2) - (-1)) + 1), (((JP + 2) - 0) + 1), (-1), 0,
                       0, i_vel2, j_vel2, k_vel2)] *
            diu5[F3D2C((((IP + 2) - (-1)) + 1), (((JP + 2) - 0) + 1), (-1), 0,
                       0, i_vel2, j_vel2, k_vel2)];
        cov9[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0, i_vel2,
                   j_vel2, k_vel2)] =
            nou9[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0,
                       i_vel2, j_vel2, k_vel2)] *
            diu9[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0,
                       i_vel2, j_vel2, k_vel2)];
      }
      if ((k_vel2 < KP)) {
        nou2[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0, i_vel2,
                   j_vel2, k_vel2)] =
            (dx1[F1D2C((-1), i_vel2 + 1)] *
                 v[F3D2C((((IP + 1) - 0) + 1), (((JP + 1) - 0) + 1), 0, 0, 0,
                         i_vel2, j_vel2 - 1, k_vel2)] +
             dx1[F1D2C((-1), i_vel2)] *
                 v[F3D2C((((IP + 1) - 0) + 1), (((JP + 1) - 0) + 1), 0, 0, 0,
        ...
        diu2[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0, i_vel2,
                   j_vel2, k_vel2)] =
            2. *
            (-u[F3D2C((((IP + 1) - 0) + 1), (((JP + 1) - 0) + 1), 0, 0, 0,
                      i_vel2, j_vel2 - 1, k_vel2)] +
        ...
        cov2[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0, i_vel2,
                   j_vel2, k_vel2)] =
            nou2[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0,
                       i_vel2, j_vel2, k_vel2)] *
            diu2[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0,
                       i_vel2, j_vel2, k_vel2)];
      }
      nou3[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0, i_vel2,
                 j_vel2, k_vel2)] =
          (dx1[F1D2C((-1), i_vel2 + 1)] *
               w[F3D2C((((IP + 1) - 0) + 1), (((JP + 1) - 0) + 1), 0, 0, 0,
                       i_vel2, j_vel2, k_vel2 - 1)] +
          ...
          (dx1[F1D2C((-1), i_vel2)] + dx1[F1D2C((-1), i_vel2 + 1)]);
      diu3[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0, i_vel2,
                 j_vel2, k_vel2)] =
      ...
      cov3[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0, i_vel2,
                 j_vel2, k_vel2)] =
          nou3[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0,
                     i_vel2, j_vel2, k_vel2)] *
          diu3[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0,
                     i_vel2, j_vel2, k_vel2)];
      if ((k_vel2 < KP)) {
        nou4[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0, i_vel2,
                   j_vel2, k_vel2)] =
            (dy1[F1D2C(0, j_vel2 + 1)] *
                 u[F3D2C((((IP + 1) - 0) + 1), (((JP + 1) - 0) + 1), 0, 0, 0,
                         i_vel2 - 1, j_vel2, k_vel2)] +
             dy1[F1D2C(0, j_vel2)] *
                 u[F3D2C((((IP + 1) - 0) + 1), (((JP + 1) - 0) + 1), 0, 0, 0,
        ...
        diu4[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0, i_vel2,
                   j_vel2, k_vel2)] =
            2. *
            (-v[F3D2C((((IP + 1) - 0) + 1), (((JP + 1) - 0) + 1), 0, 0, 0,
                      i_vel2 - 1, j_vel2, k_vel2)] +
        ...
        cov4[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0, i_vel2,
                   j_vel2, k_vel2)] =
            (nou4[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0,
                        i_vel2, j_vel2, k_vel2)] -
             u0) *
            diu4[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0,
                       i_vel2, j_vel2, k_vel2)];
      }
      nou6[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0, i_vel2,
                 j_vel2, k_vel2)] =
          (dy1[F1D2C(0, j_vel2 + 1)] *
               w[F3D2C((((IP + 1) - 0) + 1), (((JP + 1) - 0) + 1), 0, 0, 0,
                       i_vel2, j_vel2, k_vel2 - 1)] +
          ...
          (dy1[F1D2C(0, j_vel2)] + dy1[F1D2C(0, j_vel2 + 1)]);
      diu6[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0, i_vel2,
                 j_vel2, k_vel2)] =
          (-v[F3D2C((((IP + 1) - 0) + 1), (((JP + 1) - 0) + 1), 0, 0, 0, i_vel2,
           ...
           v[F3D2C((((IP + 1) - 0) + 1), (((JP + 1) - 0) + 1), 0, 0, 0, i_vel2,
                   j_vel2, k_vel2)]) /
          dzs[F1D2C((-1), k_vel2 - 1)];
      cov6[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0, i_vel2,
                 j_vel2, k_vel2)] =
          nou6[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0,
                     i_vel2, j_vel2, k_vel2)] *
          diu6[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0,
                     i_vel2, j_vel2, k_vel2)];
    });
  });
  ...
  q.submit([&](handler &hnd) {
    ...
    hnd.parallel_for(DOMAIN_SIZE, [=](id<1> item_id) {
      ...
      i_vel2_rel = ((global_id - (k_vel2_rel * (j_vel2_range * i_vel2_range))) -
                    (j_vel2_rel * i_vel2_range));
      i_vel2 = i_vel2_rel + 1;
      nou7[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0, i_vel2,
                 j_vel2, k_vel2)] =
          (dzn[F1D2C((-1), k_vel2 + 1)] *
               u[F3D2C((((IP + 1) - 0) + 1), (((JP + 1) - 0) + 1), 0, 0, 0,
                       i_vel2 - 1, j_vel2, k_vel2)] +
           dzn[F1D2C((-1), k_vel2)] *
               u[F3D2C((((IP + 1) - 0) + 1), (((JP + 1) - 0) + 1), 0, 0, 0,
      ...
      diu7[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0, i_vel2,
                 j_vel2, k_vel2)] =
          2. *
          (-w[F3D2C((((IP + 1) - 0) + 1), (((JP + 1) - 0) + 1), 0, 0, 0,
                    i_vel2 - 1, j_vel2, k_vel2)] +
           w[F3D2C((((IP + 1) - 0) + 1), (((JP + 1) - 0) + 1), 0, 0, 0, i_vel2,
                   j_vel2, k_vel2)]) /
          (dx1[F1D2C((-1), i_vel2 - 1)] + dx1[F1D2C((-1), i_vel2)]);
      cov7[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0, i_vel2,
                 j_vel2, k_vel2)] =
          (nou7[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0,
                      i_vel2, j_vel2, k_vel2)] -
           u0) *
          diu7[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0,
                     i_vel2, j_vel2, k_vel2)];
      nou8[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0, i_vel2,
                 j_vel2, k_vel2)] =
          (dzn[F1D2C((-1), k_vel2 + 1)] *
               v[F3D2C((((IP + 1) - 0) + 1), (((JP + 1) - 0) + 1), 0, 0, 0,
                       i_vel2, j_vel2 - 1, k_vel2)] +
           dzn[F1D2C((-1), k_vel2)] *
               v[F3D2C((((IP + 1) - 0) + 1), (((JP + 1) - 0) + 1), 0, 0, 0,
                       i_vel2, j_vel2 - 1, k_vel2 + 1)]) /
          (dzn[F1D2C((-1), k_vel2)] + dzn[F1D2C((-1), k_vel2 + 1)]);
      diu8[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0, i_vel2,
                 j_vel2, k_vel2)] =
          2. *
          (-w[F3D2C((((IP + 1) - 0) + 1), (((JP + 1) - 0) + 1), 0, 0, 0, i_vel2,
                    j_vel2 - 1, k_vel2)] +
           w[F3D2C((((IP + 1) - 0) + 1), (((JP + 1) - 0) + 1), 0, 0, 0, i_vel2,
                   j_vel2, k_vel2)]) /
          (dy1[F1D2C(0, j_vel2 - 1)] + dy1[F1D2C(0, j_vel2)]);
      cov8[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0, i_vel2,
                 j_vel2, k_vel2)] =
          nou8[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0,
                     i_vel2, j_vel2, k_vel2)] *
          diu8[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0,
                     i_vel2, j_vel2, k_vel2)];
    });
  });
  ...
  q.submit([&](handler &hnd) {
    ...
    hnd.parallel_for(DOMAIN_SIZE, [=](id<1> item_id) {
      ...
      covx1 = (dx1[F1D2C((-1), i + 1)] *
                   cov1[F3D2C((((IP + 2) - (-1)) + 1), (((JP + 2) - 0) + 1),
                              (-1), 0, 0, i, j, k)] +
               dx1[F1D2C((-1), i)] *
                   cov1[F3D2C((((IP + 2) - (-1)) + 1), (((JP + 2) - 0) + 1),
                              (-1), 0, 0, i + 1, j, k)]) /
              (dx1[F1D2C((-1), i)] + dx1[F1D2C((-1), i + 1)]);
      covy1 = (cov2[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0,
                          i, j, k)] +
               cov2[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0,
                          i, j + 1, k)]) /
              2.;
      covz1 = (cov3[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0,
                          i, j, k)] +
               cov3[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0,
                          i, j, k + 1)]) /
              2.;
      covc = covx1 + covy1 + covz1;
      dfu1[F3D2C(((IP - 0) + 1), ((JP - 1) + 1), 0, 1, 1, i, j, k)] =
          2. *
              (-diu1[F3D2C((((IP + 2) - (-1)) + 1), (((JP + 2) - 0) + 1), (-1),
                           0, 0, i, j, k)] +
               diu1[F3D2C((((IP + 2) - (-1)) + 1), (((JP + 2) - 0) + 1), (-1),
                          0, 0, i + 1, j, k)]) /
              (dx1[F1D2C((-1), i)] + dx1[F1D2C((-1), i + 1)]) +
          (-diu2[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0, i,
                       j, k)] +
           diu2[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0, i,
                      j + 1, k)]) /
              dy1[F1D2C(0, j)] +
          (-diu3[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0, i,
                       j, k)] +
           diu3[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0, i, j,
                      k + 1)]) /
              dzn[F1D2C((-1), k)];
      df = vn * dfu1[F3D2C(((IP - 0) + 1), ((JP - 1) + 1), 0, 1, 1, i, j, k)];
      f_1[F3D2C(((IP - 0) + 1), ((JP - 0) + 1), 0, 0, 0, i, j, k)] = -covc + df;
      covx1 = (cov4[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0,
                          i, j, k)] +
               cov4[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0,
                          i + 1, j, k)]) /
              2.;
      covy1 = (dy1[F1D2C(0, j + 1)] *
                   cov5[F3D2C((((IP + 2) - (-1)) + 1), (((JP + 2) - 0) + 1),
                              (-1), 0, 0, i, j, k)] +
               dy1[F1D2C(0, j)] *
                   cov5[F3D2C((((IP + 2) - (-1)) + 1), (((JP + 2) - 0) + 1),
                              (-1), 0, 0, i, j + 1, k)]) /
              (dy1[F1D2C(0, j)] + dy1[F1D2C(0, j + 1)]);
      covz1 = (cov6[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0,
                          i, j, k)] +
               cov6[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0,
                          i, j, k + 1)]) /
              2.;
      covc = covx1 + covy1 + covz1;
      dfv1[F3D2C(((IP - 1) + 1), ((JP - 0) + 1), 1, 0, 1, i, j, k)] =
          (-diu4[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0, i,
                       j, k)] +
           diu4[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0,
                      i + 1, j, k)]) /
              dx1[F1D2C((-1), i)] +
          2. *
              (-diu5[F3D2C((((IP + 2) - (-1)) + 1), (((JP + 2) - 0) + 1), (-1),
                           0, 0, i, j, k)] +
               diu5[F3D2C((((IP + 2) - (-1)) + 1), (((JP + 2) - 0) + 1), (-1),
                          0, 0, i, j + 1, k)]) /
              (dy1[F1D2C(0, j)] + dy1[F1D2C(0, j + 1)]) +
          (-diu6[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0, i,
                       j, k)] +
           diu6[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0, i, j,
                      k + 1)]) /
              dzn[F1D2C((-1), k)];
      df = vn * dfv1[F3D2C(((IP - 1) + 1), ((JP - 0) + 1), 1, 0, 1, i, j, k)];
      g_1[F3D2C(((IP - 0) + 1), ((JP - 0) + 1), 0, 0, 0, i, j, k)] = -covc + df;
      if ((k < (KP - 1))) {
        covx1 = (cov7[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0,
                            i, j, k)] +
                 cov7[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0,
                            i + 1, j, k)]) /
                2.;
        covy1 = (cov8[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0,
                            i, j, k)] +
                 cov8[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0,
                            i, j + 1, k)]) /
                2.;
        covz1 = (dzn[F1D2C((-1), k + 1)] *
                     cov9[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0,
                                0, 0, i, j, k)] +
                 dzn[F1D2C((-1), k)] *
                     cov9[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0,
                                0, 0, i, j, k + 1)]) /
        ...
        dfw1[F3D2C(((IP - 1) + 1), ((JP - 1) + 1), 1, 1, 1, i, j, k)] =
            (-diu7[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0, i,
                         j, k)] +
             diu7[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0,
                        i + 1, j, k)]) /
                dx1[F1D2C((-1), i)] +
            (-diu8[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0, i,
                         j, k)] +
             diu8[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0, i,
                        j + 1, k)]) /
                dy1[F1D2C(0, j)] +
            (-diu9[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0, i,
                         j, k)] +
             diu9[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0, i,
                        j, k + 1)]) /
                dzs[F1D2C((-1), k)];
