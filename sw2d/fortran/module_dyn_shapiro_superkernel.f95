...
contains
   ...
   subroutine dyn_shapiro_map_49(eta, du___dyn, dv___dyn, global_id)
   ...
   subroutine dyn_shapiro_map_55(u, du___dyn, wet, v, dv___dyn, un, vn, global_id)
   ...
   subroutine dyn_shapiro_map_75(un, h, vn, eta, etan, global_id)
   ...
   subroutine dyn_shapiro_map_92(wet, etan, etann, global_id)
   ...
   subroutine dyn_shapiro_superkernel(wet, eta, u, v, h, etann, un, vn, du___dyn, dv___dyn, etan, state, global_id)
      ...
      case (ST_DYN_SHAPIRO_MAP_49)
         call dyn_shapiro_map_49(eta, du___dyn, dv___dyn, global_id)
      case (ST_DYN_SHAPIRO_MAP_55)
         call dyn_shapiro_map_55(u, du___dyn, wet, v, dv___dyn, un, vn, global_id)
      case (ST_DYN_SHAPIRO_MAP_75)
         call dyn_shapiro_map_75(un, h, vn, eta, etan, global_id)
      case (ST_DYN_SHAPIRO_MAP_92)
         call dyn_shapiro_map_92(wet, etan, etann, global_id)
      end select
