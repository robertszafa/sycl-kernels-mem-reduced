...
double sw2d_swi(queue &q, const std::vector<int> &wet, const std::vector<float> &eta,
        ...
        for (int global_id=1; global_id < DOMAIN_SIZE; ++global_id) {
            ...
            for (s_idx_1 = 1; s_idx_1 <= 5; s_idx_1 += 1) {
                ...
                for (s_idx_3 = 1; s_idx_3 <= 3; s_idx_3 += 1) {
                    svec_etann_1_18[F3D2C(((5 - 1) + 1), ((2 - 1) + 1), 1, 1, 1, s_idx_1, s_idx_2, s_idx_3)] =
            ...
            for (s_idx_1 = 1; s_idx_1 <= 5; s_idx_1 += 1) {
                for (s_idx_2 = 1; s_idx_2 <= 2; s_idx_2 += 1) {
                for (s_idx_3 = 1; s_idx_3 <= 3; s_idx_3 += 1) {
                    svec_etann_1_19[F3D2C(((5 - 1) + 1), ((2 - 1) + 1), 1, 1, 1, s_idx_1, s_idx_2, s_idx_3)] =
            ...
            for (i___f_maps_etann_1_13 = 1; i___f_maps_etann_1_13 <= 5; i___f_maps_etann_1_13 += 1) {
                ...
                sv_u_0_in___f_comp_etann_1_6[F1D2C(1, i___f_maps_etann_1_5)] =
                    svec_etann_1_17[F2D2C(((5 - 1) + 1), 1, 1, i___f_maps_etann_1_13, i___f_maps_etann_1_5)];
                sv_du___dyn_1_in[F1D2C(1, i___f_maps_etann_1_5)] =
                    -dt___dyn_shapiro_map_49_scal * g___dyn_shapiro_map_49_scal *
                    (&svec_etann_1_18[F3D2C(((5 - 1) + 1), ((2 - 1) + 1), 1, 1, 1, i___f_maps_etann_1_13,
                                            i___f_maps_etann_1_5, 3)] -
                    &svec_etann_1_18[F3D2C(((5 - 1) + 1), ((2 - 1) + 1), 1, 1, 1, i___f_maps_etann_1_13,
                ...
                if (svec_etann_1_19[F2D2C(((2 - 1) + 1), 1, 1, i___f_maps_etann_1_2, 1)] ==
                    1) {
                    if ((svec_etann_1_19[F2D2C(((2 - 1) + 1), 1, 1, i___f_maps_etann_1_2,
                                                                3)] == 1) ||
                        (sv_du___dyn_1_in[F1D2C(1, i___f_maps_etann_1_2)] > 0.0))
                    sv_un_s_0_in___f_comp____2871b75d[F2D2C(((5 - 1) + 1), 1, 1, i___f_maps_etann_1_13,
                                                            i___f_maps_etann_1_2)] =
                ...
                sv_dv___dyn_1_in[F1D2C(1, i___f_maps_etann_1_10)] =
                    -dt___dyn_shapiro_map_49_scal * g___dyn_shapiro_map_49_scal *
                    (&svec_etann_1_18[F3D2C(((5 - 1) + 1), ((2 - 1) + 1), 1, 1, 1, i___f_maps_etann_1_13,
                                            i___f_maps_etann_1_10, 2)] -
                    &svec_etann_1_18[F3D2C(((5 - 1) + 1), ((2 - 1) + 1), 1, 1, 1, i___f_maps_etann_1_13,
                                            i___f_maps_etann_1_10, 1)]) /
                    dy___dyn_shapiro_map_49_scal;
                sv_v_0_in___f_comp_etann_1_11[F1D2C(1, i___f_maps_etann_1_10)] =
                    svec_etann_1_20[F2D2C(((5 - 1) + 1), 1, 1, i___f_maps_etann_1_13, i___f_maps_etann_1_10)];
                }
                for (i___f_maps_etann_1_8 = 1; i___f_maps_etann_1_8 <= 2; i___f_maps_etann_1_8 += 1) {
                if (svec_etann_1_19[F2D2C(((2 - 1) + 1), 1, 1, i___f_maps_etann_1_8, 1)] ==
                    1) {
                    if ((svec_etann_1_19[F2D2C(((2 - 1) + 1), 1, 1, i___f_maps_etann_1_8,
                                                                2)] == 1) ||
                        (sv_dv___dyn_1_in[F1D2C(1, i___f_maps_etann_1_8)] > 0.0))
                    sv_vn_s_0_in___f_comp____22c6c54b[F2D2C(((5 - 1) + 1), 1, 1, i___f_maps_etann_1_13,
                                                            i___f_maps_etann_1_8)] =
            ...
            for (i___f_maps_etann_1_0 = 1; i___f_maps_etann_1_0 <= 5; i___f_maps_etann_1_0 += 1) {
                hep___dyn =
                    0.5 *
                    (sv_un_s_0_in___f_comp____2871b75d[F2D2C(((5 - 1) + 1), 1, 1, i___f_maps_etann_1_0, 2)] +
                    (float)fabs(sv_un_s_0_in___f_comp____2871b75d[F2D2C(((5 - 1) + 1), 1, 1,
                ...
                hwp___dyn =
                    0.5 *
                    (sv_un_s_0_in___f_comp____2871b75d[F2D2C(((5 - 1) + 1), 1, 1, i___f_maps_etann_1_0, 1)] +
                    (float)fabs(sv_un_s_0_in___f_comp____2871b75d[F2D2C(((5 - 1) + 1), 1, 1,
                ...
                hnp___dyn =
                    0.5 *
                    (sv_vn_s_0_in___f_comp____22c6c54b[F2D2C(((5 - 1) + 1), 1, 1, i___f_maps_etann_1_0, 2)] +
                    (float)fabs(sv_vn_s_0_in___f_comp____22c6c54b[F2D2C(((5 - 1) + 1), 1, 1,
                                                                        i___f_maps_etann_1_0, 2)])) *
                    svec_etann_1_21[F2D2C(((5 - 1) + 1), 1, 1, i___f_maps_etann_1_0, 3)];
                hnn___dyn =
                    0.5 *
                ...
                hsp___dyn =
                    0.5 *
                    (sv_vn_s_0_in___f_comp____22c6c54b[F2D2C(((5 - 1) + 1), 1, 1, i___f_maps_etann_1_0, 1)] +
                    (float)fabs(sv_vn_s_0_in___f_comp____22c6c54b[F2D2C(((5 - 1) + 1), 1, 1,
                                                                        i___f_maps_etann_1_0, 1)])) *
                ...
                etan_s_0___f_comp_etann_1_16[F1D2C(1, i___f_maps_etann_1_0)] =
                    ...
                    dt___dyn_shapiro_map_75_scal * (hue___dyn - huw___dyn) / dx___dyn_shapiro_map_75_scal -
                    dt___dyn_shapiro_map_75_scal * (hvn___dyn - hvs___dyn) / dy___dyn_shapiro_map_75_scal;
            }
            if (wet_s_1[F1D2C(1, 3)] == 1) {
                term1___shapiro =
                    (1.0 - 0.25 * eps___dyn_shapiro_map_92_scal *
                            (wet_s_1[F1D2C(1, 5)] + (*wet_s_1) +
                                wet_s_1[F1D2C(1, 4)] +
                                wet_s_1[F1D2C(1, 2)])) *
                    etan_s_0___f_comp_etann_1_16[F1D2C(1, 3)];
                term2___shapiro =
                    0.25 * eps___dyn_shapiro_map_92_scal *
