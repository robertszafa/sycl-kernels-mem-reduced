...
void velfg_swi(queue &q, const std::vector<float> &u, const std::vector<float> &v,
      ...
      for (int global_id = 1; global_id < DOMAIN_SIZE; ++global_id) {
        ...
        if ((k_vel2 < KP)) {
          ...
          nou5[F3D2C((((IP + 2) - (-1)) + 1), (((JP + 2) - 0) + 1), (-1), 0, 0, i_vel2, j_vel2,
                     k_vel2)] = (v[F3D2C((((IP + 1) - 0) + 1), (((JP + 1) - 0) + 1), 0, 0, 0,
        ...
        if ((k_vel2 < KP)) {
          nou2[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0, i_vel2, j_vel2, k_vel2)] =
              (dx1[F1D2C((-1), i_vel2 + 1)] * v[F3D2C((((IP + 1) - 0) + 1), (((JP + 1) - 0) + 1), 0,
               ...
               dx1[F1D2C((-1), i_vel2)] * v[F3D2C((((IP + 1) - 0) + 1), (((JP + 1) - 0) + 1), 0, 0,
                                                  0, i_vel2 + 1, j_vel2 - 1, k_vel2)]) /
        ...
        nou3[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0, i_vel2, j_vel2, k_vel2)] =
            (dx1[F1D2C((-1), i_vel2 + 1)] * w[F3D2C((((IP + 1) - 0) + 1), (((JP + 1) - 0) + 1), 0,
                                                    0, 0, i_vel2, j_vel2, k_vel2 - 1)] +
        ...
        cov3[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0, i_vel2, j_vel2, k_vel2)] =
            nou3[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0, i_vel2, j_vel2,
                       k_vel2)] *
            diu3[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0, i_vel2, j_vel2,
                       k_vel2)];
        if ((k_vel2 < KP)) {
        ...
        nou6[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0, i_vel2, j_vel2, k_vel2)] =
            (dy1[F1D2C(0, j_vel2 + 1)] * w[F3D2C((((IP + 1) - 0) + 1), (((JP + 1) - 0) + 1), 0, 0,
        ...
        cov6[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0, i_vel2, j_vel2, k_vel2)] =
            nou6[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0, i_vel2, j_vel2,
                       k_vel2)] *
        ...
        cov7[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0, i_vel2, j_vel2, k_vel2)] =
            (nou7[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0, i_vel2, j_vel2,
                        k_vel2)] -
             u0) *
            diu7[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0, i_vel2, j_vel2,
                       k_vel2)];
        nou8[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0, i_vel2, j_vel2, k_vel2)] =
            (dzn[F1D2C((-1), k_vel2 + 1)] * v[F3D2C((((IP + 1) - 0) + 1), (((JP + 1) - 0) + 1), 0,
                                                    0, 0, i_vel2, j_vel2 - 1, k_vel2)] +
        ...
        cov8[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0, i_vel2, j_vel2, k_vel2)] =
            nou8[F3D2C((((IP + 2) - 0) + 1), (((JP + 2) - 0) + 1), 0, 0, 0, i_vel2, j_vel2,
                       k_vel2)] *
